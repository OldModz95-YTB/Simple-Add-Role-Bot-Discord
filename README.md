...
### Simple Bot Discord Add Role, NodeJS/DiscordJS@V13 | Slash Commands
<br>

## Installation
<br>

> Aller dans le fichier de variable<br>
> Ajouter votre Token<br>
> Ajouter les ID des membres qui pourrons utiliser la commande
> Dans le fichier de la commande add role, vous pouvez ajouter vos roles (Leur nom d'affiche ainsi que leur ID)
> Lancer le bot avec la commande `node` suivis du nom du fichier ainsi que `.js` à la fin.
<br><br>

<img src="https://i.imgur.com/mZbjRlO.gif" >
...
[Discord](https://www.discord.gg/3t2568W)<br>
